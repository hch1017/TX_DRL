...
from utils.model_ppo import PPO
...
def main(data_path):
    ...
    for data_path_in in data_path:
        data = pd.read_csv(data_path_in, header=None)
        ...
        torch.onnx.export(agent.policy.cpu(),
                          ...
                          "F:\TX_Distribution\multi_train_temp_model\model.onnx",
